...
#ifndef _ONE_IDLC_TREE_VISITOR_H_
#define _ONE_IDLC_TREE_VISITOR_H_
...
class TreeVisitor {
 public:
  ...
  virtual void OnLiteral(std::unique_ptr<idlc::raw::Literal> const& element) {
    idlc::raw::Literal::Kind kind = element->kind;
    switch (kind) {
...
#endif  // _ONE_IDLC_TREE_VISITOR_H_
